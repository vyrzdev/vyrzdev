...
I’m an engineer interested in the specification and implementation of performant systems.

My experience ranges across low-level implementation, hardware/software interfaces, distributed and concurrent systems, programming languages, and architecture specification. 

Some things I've worked on:
- **Linux kernel support for new hardware** - working along performance-sensitive entry/exit paths
- **Modelling systems** using TLA+, PRISM, and ASL
...
I also enjoy web and interface design, particularly giving the things I build an effective and intuitive interface.
